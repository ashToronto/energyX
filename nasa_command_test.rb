...
require_relative 'nasa_command.rb'

class TestNasaCommand < MiniTest::Unit::TestCase
  def setup
    @rover = NasaCommand.new(5,5)
  end
  ...
  def test_limit
    ...
    exception = assert_raises NasaCommand::OutOfBound do
      @rover.move_forward
    end
